...
public class MCSandbox {
    ...
    private static DirectedSparseGraph getNeighborsGraph(String blog, JungController jc)
    {
        try {
    ...
    private static HashMap<String, Double>  FOAF(DirectedSparseGraph descTree, JungController jc, String sourceUrl)
    {
        try {
...
//                  Record degrees of Each Nodes
    ...
    private static HashMap<String, Integer> neighbors(String blog)
    {
        try {  
            ...
            catch(Exception e){ System.err.println("File Not Written");}
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            HashMap<String, Double>  foaf = FOAF(descTree,jc,blog1);
...
//            companion.evaluate();
    ...
    private static void toFilePajek(DirectedSparseGraph descTree, JungController jc)
    {
        ...
        try{ pw.save(descTree, "/home/gonzo/pajek.net", jc, jc); }
        catch(Exception e){ System.err.println("File Not Written");}
